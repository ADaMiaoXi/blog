...
![loader执行流程](../../../../../.vuepress/public/assets/images/web/frontend-engineering/webpack/loader1.png)

在这个过程中如果任何 pitch 有返回值，则 loader 链被阻断。webpack 会跳过后面所有的的 pitch 和 loader，直接进入上一个 loader 。

![loader执行流程](../../../../../.vuepress/public/assets/images/web/frontend-engineering/webpack/loader2.png)
