...
![](../../../../.vuepress/public/assets/images/brainBoom/designPatterns/behavioral/iterator/iterator-zh.png)

## 问题

集合是编程中最常使用的数据类型之一。 尽管如此， 集合只是一组对象的容器而已。

![各种类型的集合。](../../../../.vuepress/public/assets/images/brainBoom/designPatterns/behavioral/iterator/problem1.png)
...
![可通过不同的方式遍历相同的集合。](../../../../.vuepress/public/assets/images/brainBoom/designPatterns/behavioral/iterator/problem2.png)
...
![迭代器可实现多种遍历算法。 多个迭代器对象可同时遍历同一个集合。](../../../../.vuepress/public/assets/images/brainBoom/designPatterns/behavioral/iterator/solution1.png)
...
![漫步罗马的不同方式。](../../../../.vuepress/public/assets/images/brainBoom/designPatterns/behavioral/iterator/iterator-comic-1-zh.png)
...
![](../../../../.vuepress/public/assets/images/brainBoom/designPatterns/behavioral/iterator/structure.png)
...
![遍历社交档案的示例](../../../../.vuepress/public/assets/images/brainBoom/designPatterns/behavioral/iterator/example-zh.png)
