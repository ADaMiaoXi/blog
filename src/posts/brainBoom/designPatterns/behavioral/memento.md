...
![](../../../../.vuepress/public/assets/images/brainBoom/designPatterns/behavioral/memento/memento-zh.png)
...
![程序在执行操作前保存所有对象的状态快照， 稍后可通过快照将对象恢复到之前的状态。](../../../../.vuepress/public/assets/images/brainBoom/designPatterns/behavioral/memento/problem1-zh.png)
...
![如何复制对象的私有状态？](../../../../.vuepress/public/assets/images/brainBoom/designPatterns/behavioral/memento/problem2-zh.png)
...
![原发器拥有对备忘录的完全访问权限， 负责人则只能访问元数据。](../../../../.vuepress/public/assets/images/brainBoom/designPatterns/behavioral/memento/solution-zh.png)
...
![](../../../../.vuepress/public/assets/images/brainBoom/designPatterns/behavioral/memento/structure1.png)
 ...
 **基于中间接口的实现**
 ...
 ![](../../../../.vuepress/public/assets/images/brainBoom/designPatterns/behavioral/memento/structure2.png)
 ...
 **封装更加严格的实现**
 ...
 如果你不想让其他类有任何机会通过备忘录来访问原发器的状态， 那么还有另一种可用的实现方式。
  ...
  ![](../../../../.vuepress/public/assets/images/brainBoom/designPatterns/behavioral/memento/structure3.png)

## 伪代码

本例结合使用了**命令**模式与备忘录模式， 可保存复杂文字编辑器的状态快照， 并能在需要时从快照中恢复之前的状态。

  ![保存文字编辑器状态的快照。](../../../../.vuepress/public/assets/images/brainBoom/designPatterns/behavioral/memento/example.png)
