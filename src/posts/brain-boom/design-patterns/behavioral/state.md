---
title: 状态模式
icon: /assets/images/brain-boom/design-patterns/behavioral/state/state-mini.png
order: 7
category:
  - 设计模式
---
...
![](../../../../.vuepress/public/assets/images/brain-boom/design-patterns/behavioral/state/state-zh.png)

## 问题

状态模式与**有限状态机**的概念紧密相关。

![有限状态机。](../../../../.vuepress/public/assets/images/brain-boom/design-patterns/behavioral/state/problem1.png)
...
![文档对象的全部状态和转移。](../../../../.vuepress/public/assets/images/brain-boom/design-patterns/behavioral/state/problem2-zh.png)
...
![文档将工作委派给一个状态对象。](../../../../.vuepress/public/assets/images/brain-boom/design-patterns/behavioral/state/solution-zh.png)
...
## 状态模式结构
![](../../../../.vuepress/public/assets/images/brain-boom/design-patterns/behavioral/state/structure-zh-indexed.png)
...
![使用状态对象更改对象行为的示例。](../../../../.vuepress/public/assets/images/brain-boom/design-patterns/behavioral/state/example.png)
